...
declare -a services=(
    ...
    "Hupoxnet Backend:/home/dock_user/web/hupoxnet/hupoxnetbackend:pm2 start npm --name=hupoxnetbackend -- run start"
    "Hupoxnet Frontend:/home/dock_user/web/hupoxnet/hupoxnetfrontend:pm2 start npm --name=hupoxnetfrontend -- run local"
